...
nf-pirate-title = Пиратство
nf-pirate-description = Банда пиратов разгуливает на свободе! Будьте осторожны и не дайте себя ограбить!

nf-test-title = Тест
nf-test-description = Настройка для тестирования. Никаких точек интереса, никаких случайных событий, состояние как есть.
...
public-transit-shuttle-name = Автобус №{$number}-{$suffix}
